async function generatePythonCode() {
    ...
    try {
        ...
        const response = await fetch('/generate_python', {
            method: 'POST',
            headers: {
        ...
        if (!response.ok) {
            throw new Error(data.detail || 'Failed to generate Python code');
        }
...
async function runCode() {
    ...
    try {
        ...
        if (!response.ok) {
            throw new Error(data.detail || 'Failed to run Python code');
        }
